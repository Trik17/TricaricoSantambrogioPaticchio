<<<<<<< Updated upstream:AlloyModelVECCHIO.als
open util/integer
open util/boolean
...
sig Notification{
	associated	: one Appointment,
	startingTimeNot: one Time
}{
	startingTimeNot = associated.startingTime
}
...
fact AppointmentNotificationTree{
	all a: Appointment | a in Notification.associated
	all a1,a2: Appointment, n1, n2: Notification | (n1!=n2 && a1 in n1.associated && a2 in n2.associated)=>
								(a1!=a2 && a1 not in n2.associated && a2 not in n1.associated)
}
...
//check AppointmentOrdering
//check OnlyOneDSInProgress
run show for 8 but exactly 1 System, exactly 1 User, exactly 1 DailySchedule, exactly 3 Appointment
>>>>>>> Stashed changes:AlloyModelNUOVO.als
